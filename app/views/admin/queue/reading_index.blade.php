...
@section('title') 阅读队列 @stop

@section('content')
<div id="content-wrapper" xmlns="http://www.w3.org/1999/html">
<div class="page-header">
    <h1><span class="text-light-gray">队列 / </span>阅读队列</h1>
</div> <!-- / .page-header -->
    ...
    <div class="col-sm-12">
        <div class="panel">
            ...
            <div class="panel-heading">
                ...
                <a href="{{route('flushKey',array('reading'))}}"  onclick="return confirm('清空后，不可恢复，确定？')"><button type="button" class="btn btn-danger" style="float: right;margin-right: 10px;" >清空该队列</button></a>
            </div>
