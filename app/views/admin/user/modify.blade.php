...
@section('title') 修改用户 @stop
@section('content')
<div id="content-wrapper">
    <div class="page-header">
        <h1><span class="text-light-gray">用户 / </span>修改用户</h1>
    </div> <!-- / .page-header -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <!-- 10. $FORM_EXAMPLE =============================================================================
                                            ...
                                            Form example
                            -->
                            <form class="panel form-horizontal"  enctype="multipart/form-data" method="post" action="{{route('adminUserPostModify')}}">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="inputEmail2" class="col-sm-2 control-label">用户名</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputEmail2" name="username" placeholder="用户名" value="{{{$user->username}}}">
                                        </div>
                                    </div> <!-- / .form-group -->
                                    <div class="form-group">
                                        <label for="inputPassword" class="col-sm-2 control-label">姓名</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputEmail2" name="name" placeholder="姓名" value="{{{$user->name}}}">
                                        </div>
                                    </div> <!-- / .form-group -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="type">
                                                <option value="1" @if($user->group_id == 1) selected="selected" @endif>系统管理员</option>
                                                <option value="2" @if($user->group_id == 2) selected="selected" @endif >校园平台BOSS</option>
                                                <option value="0" @if($user->group_id == 0) selected="selected" @endif>老师</option>
                                            </select>
                                        </div>
                                    </div> <!-- / .form-group -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="school_id">
                                                ...
                                                <option value="{{{$school->id}}}" @if($user->school_id == $school->id) selected="selected" @endif>{{{$school->name}}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div> <!-- / .form-group -->
