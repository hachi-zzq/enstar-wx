...
@section('title') 录音管理 @stop

@section('content')
<div id="content-wrapper" xmlns="http://www.w3.org/1999/html">
<div class="page-header">
    <h1><span class="text-light-gray">用户内容 / </span>录音列表</h1>
</div> <!-- / .page-header -->
    ...
    <div class="col-sm-12">
        ...
        <div class="panel">
            ...
            <div class="panel-heading">
                <span class="panel-title">录音列表</span>
            </div>
...
<!--                </div>-->
            ...
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>{{{$tape->id}}}</td>
                        <td>{{{$tape->student_id}}}</td>
                        <td>{{{$tape->lesson_id}}}</td>
                        <td>{{{$tape->report or '无'}}}</td>
                        <td>{{{$tape->score}}}</td>
        ...
        <div class="row pagination-demo">
            <div class="col-sm-12">
                <ul class="pagination">
                    {{$tapes->appends(Input::except('page'))->links()}}
                </ul>
            </div>
        </div>
    </div>
